...
**Demo recording:** April 5, 2026 — treat **“last night’s update”** as the **April 4, 2026** evening deploy of `v1.2.4`.

## Scenario

- `v1.2.3` — stable signup funnel  
- `v1.2.4` — deploy that regressed checkout (Stripe Elements mount / form null ref), shipped **2026-04-04**  
